...
node_limit = 300*1000*1000 # approx 35% per node utilized  #Parameter (same here this could be bandwidth or io as above, not sure, assuming io for now)
pod_limit =((k*k*node_limit)/4)  #Parameter  (this could be io or bandwidth, not sure about the limit)
